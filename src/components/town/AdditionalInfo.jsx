  ...
  return (
    <MoreInfo>
      ...
      <Flex direction="column" margin="10px">
        ...
        <img src={day} alt="" />
        <p className="more-info__value">{temperatureMax}{measure}</p>
      </Flex>
      <Flex direction="column" margin="10px">
        <p className="more-info__param">Night</p>
        <img src={night} alt="" />
        <p className="more-info__value">{temperatureMin}{measure}</p>
      </Flex>
      <Flex direction="column" margin="10px">
        <p className="more-info__param">Wind</p>
        <img src={wind} alt="" />
        <p className="more-info__value">{info.wind.speed}m/s,<br/>{degWind}</p>
      </Flex>
      </Flex>
      <Flex justify="space-between" align='start'>
      <Flex direction="column" margin="10px">
